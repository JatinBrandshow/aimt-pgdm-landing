...
const ProgrammeOverview = () => {
    return (
        <>
            <section className="py-14 bg-white max-md:py-8 max-sm:py-6 px-2">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        {/* --- Left Content --- */}
                        <div className="space-y-6">
                            <h2 className="text-4xl font-bold text-gray-900 max-lg:text-3xl max-md:text-2xl max-sm:text-xl">About the PGDM Programme</h2>
