      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              The <strong>Post Graduate Diploma in Management (PGDM)</strong> is
              a two-year, full-time program approved by the
              <strong> AICTE, Ministry of Education, Govt. of India.</strong>
              Designed with inputs from industry leaders, the programme blends
              academic rigor with practical corporate exposure.
            </motion.p>
